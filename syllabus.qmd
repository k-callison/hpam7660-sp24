...
We'll use R in this class to conduct data analysis. R is free, open source, and available on all major platforms. [RStudio](http://www.rstudio.com) (also free) is a user interface for R that is commonly used to work with the R language. R is available in all Tulane computer labs and you are encouraged to bring your laptop to class if you're able to. [Data Lab 1](/assignments/tutorial_1) will walk you through setting up R and RStudio on your laptop.
...
1.  Problem statement – Feb. 27th\
2.  Preliminary reference list – March 13th\
3.  Introduction and problem definition draft – March 27th\
4.  Issue analysis draft – April 3rd\
5.  Proposed solutions draft – April 10th\
6.  Strategic recommendations draft – April 17th\
7.  Executive summary and conclusions draft – April 24th\
8.  Final draft – May 1st\

*Case Presentation* - The case presentations will take place on April 22nd, April 24th, and April 29th.  I’ll provide more detail on the course web site along with a rubric for the case presentations.  
