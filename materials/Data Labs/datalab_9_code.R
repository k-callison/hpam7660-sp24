...
#Step 2 & Step 3
acs_data <- readRDS("/Users/kcallison/Dropbox/Documents/Data/HPAM7660/acs_datalab8.rds")
...
ggplot(acs_LA_race_graph, aes(x = YEAR)) +
  ...
  labs(title = "Uninsured Rate in Louisiana by Race, 2012 - 2019",
       ...
       y = "Share Covered",
       color = "Race") +
  scale_color_discrete(labels = c("white", "Black/African American", "Asian", "Other", "Hispanic")) +
  ylim(0, 0.8) +
  theme_minimal()
