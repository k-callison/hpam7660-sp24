...
Deconstruct complex problems into smaller elements and synthesize that with other data to derive recommendations. (Critical Thinking and Analysis) | P | 6,7 |<br>
<font size= "2"> Rating Scale for Degree of Coverage: P = primary, R = reinforcing <font size= "5"> <br> 
