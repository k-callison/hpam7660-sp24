...
2. Preview the `drinks` data frame from the `fivethirtyeight` package using one of the methods we covered in [Data Lab 2](/materials/Data Labs/datalab_2.qmd). (Hint: you should avoid using the `View()` command here because Markdown won't like it.)
...
11. Preview the data using one of the methods we covered in [Data Lab 2](/materials/Data Labs/datalab_2.qmd). (Hint: you should avoid using the `View()` command here because Markdown won't like it.)

12. Is this data frame in "tidy" format? If yes, then explain why. If not, then convert the data to "tiny" format.

13. Once you've finished Step 12, knit your PDF document, upload it to the Problem Set 1 assignment [link](https://tulane.instructure.com/courses/2306287/assignments/14888497) on Canvas you're done!