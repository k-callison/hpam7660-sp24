...
- submit any reading discussion questions, problem sets, or other assignments by 2:30pm on the assigned due date
...
- **Assignment** ({{< fa pen-ruler >}}): This page contains the instructions for each assignment. **Assignments are due by 2:30 PM on the day they're listed.** 
