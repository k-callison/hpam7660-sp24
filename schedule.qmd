...
- [**Materials**](/materials/) ({{< fa book-open-reader >}}): This page contains the readings, slides, and videos (if any) for the topic. Do the readings and watch the videos before coming to class on the indicated date. Slides will typically be posted before each class.
- **Tutorial** ({{< fa laptop-code >}}): A link to the tutorial for that week (if any). 
