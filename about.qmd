...
- {{< fa user >}} &nbsp; [{{< var instructor.name_title >}}]({{< var instructor.url >}})
- {{< fa university >}} &nbsp; {{< var instructor.office >}}
- {{< fa envelope >}} &nbsp; <a href="mailto:{{< var instructor.email >}}">{{< var instructor.email >}}</a>
- {{< fa globe-pointer >}} &nbsp; [Webpage]({{< var instructor.website_url >}})
...
- {{< fa globe-pointer >}} &nbsp; [Webpage]({{< var instructor.website_url2 >}})
